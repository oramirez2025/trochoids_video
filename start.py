...
class trochoids(Scene):
    def construct(self):
        ...
        slabel = Tex("Start").next_to(start, UP, buff=0.3)
        ...
        glabel = Tex("Goal").next_to(goal, UP, buff=0.5)
        ...
        svec = Arrow(start=[x0,y0,0],end=[x0+0.5,y0-0.40,0],buff=0,stroke_color="#000000",stroke_width=2)
        gvec = Arrow(start=[x1,y1,0],end=[x1+0.5,y1-0.2,0],buff=0,stroke_color="#000000",stroke_width=2)
        ...
        mvec = Arrow(start=[x2,y2,0.0],end=[x2+0.5,y2-0.2,0.0],buff=0,stroke_color="#000000",stroke_width=2)
